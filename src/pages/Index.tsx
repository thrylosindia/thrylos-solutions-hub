    ...
    <MainLayout>
      ...
      >
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-600/10 blur-3xl rounded-full" />
        </div>
        {/* Floating upward particles */}
            <div className="absolute inset-0 z-10 pointer-events-none overflow-hidden">
        {[...Array(80)].map((_, i) => {
          const size = 1 + Math.floor(Math.random() * 10); // px
          const left = Math.random() * 100;
          const delay = Math.random() * 1.2;
          const duration = 1.2 + Math.random() * 1.6; // fast
          ...
          height: `${size}px`,
          left: `${left}%`,
          bottom: `${-10 - Math.random() * 20}%`, // start slightly below the viewport
        ...
        <div className="relative z-20 w-full flex flex-col items-center justify-center">
          ...
          <motion.div
            ...
            className="absolute top-[8%] sm:top-[10%] left-0 px-2 sm:px-6"
          >
            <h1 className="text-[2rem] xs:text-[3rem] sm:text-[6rem] md:text-[10rem] lg:text-[14rem] font-black text-white leading-none tracking-tight">
              BEYOND
            </h1>
          </motion.div>
          ...
          >
            <h1 className="text-[2rem] xs:text-[3rem] sm:text-[6rem] md:text-[10rem] lg:text-[14rem] font-black text-white leading-none tracking-tight text-right">
              TECH
            </h1>
          </motion.div>
        </div>
